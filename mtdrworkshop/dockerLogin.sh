...
kubectl create secret docker-registry todolistpullsecret2 --docker-server=$MTDRWORKSHOP_REGION --docker-username=$MTDRWORKSHOP_OCIR_NAMESPACE/$MTDRWORKSHOP_OCIR_USER  --docker-password=$MTDRWORKSHOP_OCIR_AUTHKEY --docker-email=vijay.balebail@oracle.com
